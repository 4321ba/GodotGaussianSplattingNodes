...
func _process(delta):
	...
	var move_input3 = Input.get_action_strength("ui_page_up") - Input.get_action_strength("ui_page_down")
	cam.translate(Vector3(move_input2 * cam_speed * delta, move_input3 * cam_speed * delta, -move_input * cam_speed * delta))
