...
static func load_gaussian_splats(point_cloud : SplatCloudData, stride : int, device : RenderingDevice, buffer : RID, should_terminate_reference : Array[bool], num_points_loaded : Array[int], callback : Callable):
